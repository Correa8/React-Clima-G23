...
const App = () => {
  ...
  const url = `https://openweathermap.org/geo/1.0/direct?q=${location}&limit=5&appid=1d4407cd8e297ed94b328101b6d05461`
          ...
          <>
            <div className="impu">
              <form onSubmit={handleSubmit} className="  gap-3">
                <input
                  /* value={locacion}
                  onChange={(event) => setLocacion(event.target.value)}
